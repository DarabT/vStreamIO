...
class Player:
    ...
    **Kodi's player.**
    ...
    def __init__(self, dt_second_arg = '') -> None:
        pass
...
def executeJSONRPC(jsonrpccommand: str) -> str:
    # On retourne une réponse JSON valide sous forme de chaîne de caractères.
    return '{"id": 1, "jsonrpc": "2.0", "result": {"label": "vStreamIO_Profil_Skip", "thumbnail": "path/to/thumbnail.jpg", "lockmode": 0}}'
